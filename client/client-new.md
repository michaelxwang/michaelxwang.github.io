...
<ul style="list-style-type:none;">
  ...
  <br>
  <li>&rarr; [2a] Before the season starts, please upload your last year returns, describe what is new in current and special situations. During the seasonal peak, please upload your <mark>complete</mark> set of current-year tax documents for the current year according to the <a href="/cat/tax/2025/12/31/tax-check-list.html" target="_blank">checklist</a> (<mark>this is a clickable link</mark>).</li>
  <li>&larr; [2b] We will let you know if we can do it, and if so we will provide an estimate.</li>
  <br>
