...
- Details on HSA:
  ...
  - (-) Can have Limited Purpose FSA (LPFSA): LPFSA can be used by dental and vision expense anytime. However for other medical expense, you will need to meet all deductible before using LPFSA. Debit card takes care of this automatically.
