---
layout: post
title: "Two aspects of the a company: legal and tax"
categories:
- tax
---
...
I strongly recommend finding a good payroll company to handle these tasks for you.
...
For example, you can have wages through W-2 and business income through K-1.
...
While filing as S-Corp, only the wages are subject to FICA tax, not the business income. This seems to indicate filing as S-Corp has
a huge advantage, and many accounts advertise this as a tax-saving strategy. While this has a bit of truth at the low end of income,
the benefit is reduced when you pay yourself a reasonable compensation, and
it vanishes when you reached the maximum wage base. When you have a job at another company,
that has paid the maximum social security tax, the effect gets reversed  
because the S-Corp has its limit of the social security tax while the sole proprietorship does not.

The interacting factors that affect FICA taxes are:

- The larger part of the FICA taxes, the social security tax has an upper limit per person,
so how much you can save is capped. If you have wages from another job, you might have reached the maximum, and
there is nothing to save. 

- At a high-income level ($200,000 for single status in the year 2021), the business income is subject to 3.8%
Net Investment Income Tax ([Form 8960][form_8960]) kicks in, which is precisely the 2.9% regular medicare tax plus
0.9% Additional Medicare Tax ([Form 8959][form_8959]), so the minor part of the FICA taxes, the medicare tax, is equalized also.
<br/>
<br/>
The net investment income tax (NIIT) was implemented as part of the [Affordable Care Act (ACA)][aca], also known as Obamacare, which was signed into law on March 23, 2010. The NIIT went into effect on January 1, 2013.
From this, I can see that the disparity is accidental, and congress is aware of it. It took an opportunity and patched
the disparity at the high end of the income. By the way, although this is a numeric equivalent of the medicare tax, it is not part of the payroll deduction.

- The IRS requires that you pay yourself a [reasonable][reasonable] compensation
which does not enjoy a 20% Qualified Business Income Deduction [QBID][qbid] allowed by
the [Tax Cuts and Jobs Act of 2017][tcja] (which will expire in 2025). 
<br/>
<br/>
How much is
a reasonable amount depends on the nature of your job, and the field
...
- When you have wages from a company of not your own, the disparity magnifies in favor of self-employment because
the self-employment tax stops completely at either of the employee side and employer side, see line 8a of [Schedule SE][schedule_se], but the payroll tax continues at
the employer side when you pay yourself. This makes some sense because the S-Corp is a separate entity, and it has to reach its own
maximum. 

- Another inconsistency of the smaller effect in favor of self-employment is the net income base for self-employment tax
is reduced to 92.35% of the net income. This reduction factor is hard-coded in line 4a of [Schedule SE][schedule_se]. The reduction
is the employer portion (7.65%) of the self-employment tax, i.e. 1 - 7.65% = 93.25%. This makes sense when you pay it,
but the law allows you to have the deduction even if you are not paying it, either because your other w-2 income already satisfies the
maximum social security tax, or the self-employment income exceeds the limit. 
...
|Sequence No| Filing As |Other Income| Your Income | Wages Paid | Business Income |Secial Security Tax Employor|Secial Security Tax Employee |Medicare Tax Employor | Medicare Tax Employee |Other Tax|Income Tax |Total |
|---|:----------|---:|-------------:|--------------:|------:|--------------:|------:|---:|--------------:|------:|---:|---:|
...
- 1b: Business Income is reduced by wages paid, employer portion of FICA taxes. Since the FICA taxes are skipped on business income distribution in this low-end model, there is a small "savings" on FICA taxes ($2,734).
- 1c: Business Income is zero after reducing wages paid, and employer portion of FICA taxes. You pay more taxes ($8,195) mainly because the wages paid do not have qualified business income deductions.
...
- 2b: Business Income is reduced by wages paid, employer portion of FICA taxes. Since the Business Income skipped the payroll taxes, the FICA taxes are recaptured in other taxes (Additional Medicare Tax and NIIT Tax).
You pay more taxes at the high-income level ($4,751) mainly because the S-Corp has to be social security tax ($6,200).
- 2c: Business Income is zero after reducing wages paid, and employer portion of FICA taxes. Since the FICA taxes are recaptured at a high-income level, the total taxes paid is almost the same. The small difference
...
I have seen too many businesses without activities, and have to close.
I would recommend concentrating on your services, your products, and
your client base. I hope this post can help you to make a good decision.
