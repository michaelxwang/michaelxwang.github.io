...
|          |          | >= $19,001 &&<br> <= $15,000,000 | Yes | No |
|          |          | >= $15,000,001 | Yes | Yes (up to 40%) |
| Anybody  | Non-US citizen<br> Spouse | <= $194,000 | No | No |
|          |          | >= $194,001 &&<br> <= $15,000,000 | Yes | No |
|          |          | >= $15,000,001 | Yes | Yes (up to 40%) |
| Anybody  | US Citizen<br> Spouse | Any Amount | No | No |
| Nonresident<br> (US Property) | Resident &<br>Nonresident | <= $19,000 | No | No |
|                               |                           | >= $19,001 | Yes | Yes (up to 40%) |
